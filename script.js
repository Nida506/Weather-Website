...
function displayWeatherDetail(
  ...
  <p class =" h6 ms-2 font fw-bold">✔ ${dateTime}</p>
  <p class =" h6 ms-2">✔ <span class="fw-bold">Weather</span> : ${weather}</p>
  <p class =" h6 ms-2">✔ <span class="fw-bold">City</span> : ${name} ${country}</p>
    <p class =" h6 ms-2">✔ <span class="fw-bold">Temperature</span> : ${temp}&degC</p>
    <p class =" h6 ms-2">✔ <span class="fw-bold">Feels_Like</span> : ${tempFeelsLike}&degC</p>
    <p class =" h6 ms-2">✔ <span class="fw-bold">Temp_Min</span> : ${tempMin}&degC</p>
    <p class =" h6 ms-2">✔ <span class="fw-bold">Temp_Max</span> : ${tempMax}&degC</p>

    
    <p class ="h6 ms-2">✔ <span class="fw-bold">Wind_spaeed</span> :${windSpeed}</p>
    <p class ="h6 ms-2">✔ <span class="fw-bold">Humidity</span>: ${humidity}</p>
